                            ...
                            <tbody>
                              ...
                              ?>
                                <tr data-details="c01" class="itemDetails">
                                  <td><?php echo $res['AVID'] ?></td>
                                  <td> <?php echo $res['name'] ?></td>
                                  <td><?php echo $res['mobile'] ?></td>
                                  <td><?php echo $res['Address'] ?></td>
                                  <td><?php echo $res['DOB'] ?></td>
                                  <td><?php echo $res['Designation'] ?></td>
                                  <!-- <td></td><i class="fa fa-object-group"></i></td> -->
                                </tr>



                                <tr id="c01" class="aside hidden">
                                  <!-- <tr> -->
                                  <!-- <tbody > -->
                                  ...
                                  <td>
                                    ...
                                    <p><?php echo $res['active_doner'] ?></p>
                                  </td>
                                  <td>
                                    <h4>
                                      No. of Family Members
                                    </h4>
                                    <p><?php echo $res['family'] ?></p>
                                  </td>
                                  <td>
                                    <h4>
                                      Gotra1
                                    </h4>
                                    <p><?php echo $res['Gotra_1'] ?></p>
                                  </td>
                                  <td>
                                    <h4>
                                      Gotra2
                                    </h4>
                                    <p><?php echo $res['Gotra_2'] ?></p>
                                  </td>
                                  <td>

                                    <?php echo "<img style='width: 50px; height: 50px' src='" . $res['photo'] . "'>" ?>
                          ...
                          <script>
                            $(function() {
                              ...
                              $('tr.itemDetails').click(function() {
                                ...
                                $('tr.hidden tr:nth-child(' + (index + 1) + ')').css('display', 'table-row');
                              });
                            });
                          </script>
                        </div>
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped table-hover" id="table_detail">
                            ...
                            <tbody>
                              ...
                              ?>
                                <tr data-details="c02" class="itemDetails2">
                                  <td><?php echo $res['D_ID'] ?></td>
                                  <td> <?php echo $res['D_name'] ?></td>
                                  <td><?php echo $res['D_type'] ?></td>
                                  <td><?php echo $res['Amount_Qty'] ?></td>
                                  <td><?php echo $res['AVID'] ?></td>
                                  <td>
                                    <?php $status = $res['status'];
                                if($status == 'Pending') $strStatus = "<button class='button-24' role='button'><a href=statusCompleted.php?D_ID=".$res['D_ID']."> Donation Completed</a></button>";
                                // if($status == 'Completed') $strStatus = "<button class='button-5' role='button'><a href=statusPending.php?D_ID=".$res['D_ID']."> Donation Pending</a></button>";
                                if($status == 'Completed') $strStatus = "<button class='button-24' role='button'><a href=statusPending.php?D_ID=".$res['D_ID']."> Donation Pending</a></button>";
                                echo $strStatus;
                                ?>
                                </td>

                                  <td><?php echo $res['donated_to'] ?></td>
                                  <!-- <td><a href="#" class="aa" onclick="toggle();"><i class="fa fa-object-group"></i></a></td> -->
                                </tr>

                                <tr id="c02" class="aside hidden2">
                                  <td>
                                    <h4>
                                      Description
                                    </h4>
                          ...
                          <script>
                            $(function() {
                              $('tr.hidden2').css('display', 'none');
                              $('tr.itemDetails2').click(function() {
                                var index = $(this).index();
                                $('tr.hidden2').css('display', 'block');
                                // $('tr.hidden').css('display', 'none');
                                // $('table.hidden tr:first-child').css('display', 'table-row');
                                $('tr.hidden2 tr:nth-child(' + (index + 1) + ')').css('display', 'table-row');
                              });
                            });
                          </script>
                        </div>
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped table-hover">
                            ...
                            <tbody>
                              ...
                              ?>
                                <tr>
                                  <td><?php echo $res['Support_id'] ?></td>
                                  <td><?php echo $res['Support_AVID'] ?></td>
                                  <td> <?php echo $res['Support_type'] ?></td>
                                  <td><?php echo $res['Description'] ?></td>
                                  <td><?php echo $res['Qty'] ?></td>

                                  <td>
                                  <?php $Response = $res['Response'];
                                  if($Response == 'Pending') $strStatus = "<button class='button-24' role='button'><a href=statusCompleted2.php?Support_id=".$res['Support_id']."> Support Completed</a></button>";
                                  if($Response == 'Complete') $strStatus = "<button class='button-24' role='button'><a href=statusPending2.php?Support_id=".$res['Support_id']."> Support Pending</a></button>";
                                // if($Response == 'Pending') $strStatus = "<a href=statusCompleted2.php?Support_id=".$res['Support_id']."> Support Completed</a>";
                                // if($Response == 'Completed') $strStatus = "<a href=statusPending2.php?Support_id=".$res['Support_id']."> Support Pending</a>";
                                echo $strStatus;
                                ?>
                                  </td>
                                </tr>
              ...
              <!-- <div class="wrapper" style="float: right; justify-content: flex-end;">
                <a class="button" href="#">
                  <button id="myBtn" class="button" style="border: none; padding: 1vh 0.5vh; min-width: 5.23em">Approve</button>
                </a>
              </div> -->
            </div>
          </div>
