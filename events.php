    ...
    <section id="event-list" class="event-list">
      <div class="container">
        ...
        <div class="row">
          ...
          <?php
          include_once 'db.php';                              
           $sql = "SELECT photo,name,time,date,description FROM youth_activity";
            ...
            while ($row = $result-> fetch_assoc()){
              ...
              <div class="card">
                <div class="card-img">
                  <?php
                // $imageURL = 'admin-panel/youth_activity_img/'.$row["photo"]; 
                ...
                <div class="card-body">
                  ...
                  <p class="fst-italic text-center"><?php echo $row["date"];?><span> <?php echo $row["time"] ;?></span></p>
