...
<script  src="function.js"></script>
  ...
  <main id="main">
    ...
    <!-- ======= Gallery Section ======= -->
    <section id="gallery" class="gallery" style="padding-top: 2vh; padding-bottom: 2vh;">
      <div class="container">
                ...
                <div class="table-wrapper">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            include_once 'db.php'; 
                             $sr=0;
                            //  $sql = "SELECT name,blood,address,mobile FROM add_doner";
        ...
        <div class="wrapper">
            <a class="button" href="#"><button id="myBtn" class="button" style="border: none;">Add Donor</button></a>
        </div>   
        <div id="myModal" class="modal">
            ...
            <div class="modal-content">
              ...
              <form action="donate4.php" method="post">
                <div class="user-details" style="display: flex;
                flex-wrap: wrap;
                justify-content: space-around;">
                    <div class="input-group mb-2" style="display: flex;
                    justify-content: center; margin-bottom: 4vh !important; width: 70%;">
                <div class="input-group-prepend">
                    <label class="input-group-text" for="inputGroupSelect01" style="border-top-left-radius: 15px; border-bottom-left-radius: 15px;">Blood Group
                    </label>
                </div>
                <select class="custom-select" id="inputGroupSelect01" style="border-top-right-radius: 15px;
        border-bottom-right-radius: 15px;" name="blood" required>
              ...
              <div class="input-box">
                ...
                <input type="text" name="name" placeholder="Name of Blood Donor" required>
              </div>
              
              <div class="input-box">
                <span class="details">Mobile Number</span>
                <input type="number" name="mobile" placeholder="Donor Phone" required>
              </div>
              
              <div class="input-box">
                <span class="details">Address</span>
                <input type="text" name="address" placeholder="Address of Donor" required>
              </div>
            </div>
              <!-- <div class="button">
            ...
            <input type="submit" name="sumbit" value="Add Donor">
         </div>
        </center>
    </form>
            </div>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">EasyTechs</a>
      </div>
    </div>
  </footer><!-- End Footer -->
