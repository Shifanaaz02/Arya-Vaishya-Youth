      ...
      function format ( d ) {
        ...
        return '<table cellpadding="5" cellspacing="0" border="0" style="width:100%;">'+
            '<tr class="expanded-row">'+
                '<td colspan="8" class="row-bg"><div><div class="d-flex justify-content-between"><div class="expanded-table-normal-cell"><div class="mr-2 mb-4"><p>Description</p><h6>Lorem Impsum Donor</h6></div><div class="mr-2"></div></div><div class="expanded-table-normal-cell"><div class="mr-2"></div><div class="mr-2"><p>Remaining</p><h6>Left Out Portion of Table</h6></div></div><div class="expanded-table-normal-cell"><div class="mr-2 mb-3 d-flex"><div class="highlighted-alpha"> A</div><div><img src=""> </div></div><h6>Photo</h6></div></div></div></div></div></td>'
            '</tr>'+
        '</table>';
    }
